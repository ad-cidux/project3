<div class="header">
    <div class="header_resize">
        ...
        <div class="clr"></div>
        <div class="slider">
            <div id="coin-slider"> <a href="#"><img src="{{asset('/front/')}}/images/slide1.jpg" width="935" height="307" alt="" /> </a>
                <a href="#"><img src="{{asset('/front/')}}/images/slide2.jpg" width="935" height="307" alt="" /> </a>
                <a href="#"><img src="{{asset('/front/')}}/images/slide3.jpg" width="935" height="307" alt="" /> </a> </div>
            <div class="clr"></div>
        </div>
        <div class="clr"></div>
    </div>
